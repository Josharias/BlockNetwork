...
public class SidedLocationNetworkNodeTest {
    ...
    public void filterToSpecificSides() {
        ...
        Predicate<TwoNetworkNodes> filter = SidedLocationNetworkNode.createSideConnectivityFilter(Side.TOP, bottom.location);
        assertTrue(filter.apply(new TwoNetworkNodes(top, bottom)));

        filter = SidedLocationNetworkNode.createSideConnectivityFilter(Side.TOP, bottom.location);
        assertFalse(filter.apply(new TwoNetworkNodes(side, bottom)));
    }
